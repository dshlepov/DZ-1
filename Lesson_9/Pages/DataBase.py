...
class DataBase:
    ...
    def create_employer(self, company_id: int, first_name: str, phone: str):
        return self.execute_query('item_INSERT', {'id', company_id, 'name': first_name, 'surname': last_name, 'phone_nam': phone })
